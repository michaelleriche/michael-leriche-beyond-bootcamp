...
const recipes = [
  ...
  {
    name: 'Veggie Burgers',
    link: 'https://minimalistbaker.com/easy-grillable-veggie-burgers/',
    vegetarian: true,
    vegan: true,
    dairyFree: false,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/spicy-baked-fish-tacos-30-minutes/',
    vegetarian: true,
    vegan: false,
    dairyFree: false,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/easy-banana-ice-cream-tips-2-methods-10-flavors/',
    vegetarian: true,
    vegan: true,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/1-pot-curried-chickpea-soup/',
    vegetarian: true,
    vegan: true,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/easy-1-pan-salmon-red-curry/',
    vegetarian: false,
    vegan: false,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/easy-gluten-free-pasta-grain-free/',
    vegetarian: true,
    vegan: false,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/chickpea-chopped-kale-salad-with-adobo-dressing/',
    vegetarian: true,
    vegan: true,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/1-pan-potato-aloo-sabzi/',
    vegetarian: true,
    vegan: true,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/cozy-thai-inspired-chicken-noodle-soup/',
    vegetarian: false,
    vegan: false,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/black-bean-buddha-bowl-with-gingery-lemon-tahini-sauce/',
    vegetarian: true,
    vegan: true,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/spring-frittata-with-leeks-asparagus-and-sweet-potato/',
    vegetarian: true,
    vegan: false,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/mayo-free-deviled-eggs/',
    vegetarian: true,
    vegan: false,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/easy-green-chile-chicken-tamales/',
    vegetarian: false,
    vegan: false,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/perfect-hard-boiled-eggs-every-time-3-ways/',
    vegetarian: true,
    vegan: false,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/crispy-breaded-cauliflower-wings/',
    vegetarian: true,
    vegan: false,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/classic-gluten-free-lasagna-dairy-free/',
    vegetarian: false,
    vegan: false,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/easy-chinese-chicken-salad-gf-soy-free/',
    vegetarian: false,
    vegan: false,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/1-pot-tuscan-style-beef-lentil-soup/',
    vegetarian: false,
    vegan: false,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/roasted-broccoli-pasta-salad-with-hemp-pesto-v-gf/',
    vegetarian: true,
    vegan: true,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/cozy-turmeric-porridge-1-pot/',
    vegetarian: true,
    vegan: true,
    dairyFree: true,
    glutenFree: true,
  ...
  {
    name: 'Breakfast Bowl',
    link: 'https://minimalistbaker.com/the-simple-but-good-breakfast-bowl-20-minutes/',
    vegetarian: true,
    vegan: false,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/creamy-curried-cauliflower-lentil-soup-1-pot/',
    vegetarian: true,
    vegan: true,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/sauteed-kale-with-lemon-tahini-hemp-seeds/',
    vegetarian: true,
    vegan: true,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/creamy-vegan-broccoli-salad-mayo-free/',
    vegetarian: true,
    vegan: true,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/easy-1-pot-tikka-masala/',
    vegetarian: false,
    vegan: false,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/blender-banana-pancakes-gluten-free/',
    vegetarian: true,
    vegan: false,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/5-ingredient-almond-butter-dark-chocolate-snowballs/',
    vegetarian: true,
    vegan: true,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/1-bowl-pumpkin-pie-vegan-gf/',
    vegetarian: true,
    vegan: true,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/no-bake-vegan-chai-cheesecake/',
    vegetarian: true,
    vegan: true,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/cranberry-pumpkin-steel-cut-oats/',
    vegetarian: true,
    vegan: true,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/lemon-herb-roasted-chicken/',
    vegetarian: false,
    vegan: false,
    dairyFree: false,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/miso-glazed-roasted-brussels-sprouts/',
    vegetarian: true,
    vegan: true,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/5-ingredient-vegan-chocolate-turtles/',
    vegetarian: true,
    vegan: true,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/1-pot-pumpkin-black-bean-soup/',
    vegetarian: true,
    vegan: true,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/grain-free-burrito-bowls-with-shredded-mexican-chicken/',
    vegetarian: false,
    vegan: false,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/1-pan-mexican-shredded-chicken/',
    vegetarian: false,
    vegan: false,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/1-pot-spiced-sweet-potato-lentil-soup/',
    vegetarian: true,
    vegan: true,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://minimalistbaker.com/peanut-butter-banana-chickpea-shake-5-ingredients/',
    vegetarian: true,
    vegan: true,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://tasty.co/recipe/bacon-asparagus-pastry-twists',
    vegetarian: false,
    vegan: false,
    dairyFree: false,
    glutenFree: false,
  ...
  },
  {
    ...
    link: 'https://tasty.co/recipe/baked-lobster-tails',
    vegetarian: false,
    vegan: false,
    dairyFree: false,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://tasty.co/recipe/bacon-avocado-caesar-salad',
    vegetarian: false,
    vegan: false,
    dairyFree: false,
    glutenFree: false,
  ...
  },
  {
    ...
    link: 'https://tasty.co/recipe/creamy-tuscan-chicken',
    vegetarian: false,
    vegan: false,
    dairyFree: false,
    glutenFree: true,
  ...
  {
    name: 'Best Buddha Bowl',
    link: 'https://www.loveandlemons.com/buddha-bowl-recipe/#wprm-recipe-container-43905',
    vegetarian: true,
    vegan: true,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://www.loveandlemons.com/banh-mi/',
    vegetarian: true,
    vegan: true,
    dairyFree: true,
    glutenFree: false,
  ...
  },
  {
    ...
    link: 'https://www.loveandlemons.com/summer-rolls/',
    vegetarian: true,
    vegan: true,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://www.loveandlemons.com/sesame-soba-noodles/',
    vegetarian: true,
    vegan: false,
    dairyFree: true,
    glutenFree: true,
  ...
  {
    name: 'Pressed Broccoli Rabe and Mozzarella Sandwiches',
    link: 'https://www.epicurious.com/recipes/food/views/pressed-broccoli-rabe-and-mozzarella-sandwiches',
    vegetarian: true,
    vegan: false,
    dairyFree: false,
    glutenFree: false,
  ...
  },
  {
    ...
    link: 'https://www.bonappetit.com/recipe/crispy-skin-salmon-with-miso-honey-sauce',
    vegetarian: false,
    vegan: false,
    dairyFree: true,
    glutenFree: true,
  ...
  },
  {
    ...
    link: 'https://www.bonappetit.com/recipe/one-pot-chicken-and-rice',
    vegetarian: false,
    vegan: false,
    dairyFree: true,
    glutenFree: true,
  ...
  {
    name: 'Sheet Pan Chicken Meatballs with Tomatoes and Chickpeas',
    link: 'https://www.bonappetit.com/recipe/sheet-pan-chicken-meatballs-with-tomatoes-and-chickpeas',
    vegetarian: false,
    vegan: false,
    dairyFree: false,
    glutenFree: false,
  ...
  {
    name: 'Pantry Pasta',
    link: 'https://www.bonappetit.com/recipe/pantry-pasta',
    vegetarian: false,
    vegan: false,
    dairyFree: false,
    glutenFree: false,
  ...
  {
    name: 'Pounded Flank Steak with Zucchini Salsa',
    link: 'https://www.bonappetit.com/recipe/pounded-flank-steak-with-zucchini-salsa',
    vegetarian: false,
    vegan: false,
    dairyFree: true,
    glutenFree: true,
  ...
  {
    name: 'Kielbasa and Lentil Soup with Lots of Basil',
    link: 'https://www.bonappetit.com/recipe/kielbasa-and-lentil-soup-with-lots-of-basil',
    vegetarian: false,
    vegan: false,
    dairyFree: false,
    glutenFree: true,
...
const funnySell = [
  ...
  `Put on some tunes, dance around your kitchen, and dig into:`,
...
let a = document.createElement('a'); 
  ...
  function displayRecipe() {
    ...
    if (answerChop.length === 0) {
      recipeElement.innerHTML = `No recipes match your criteria.<br>(But we're working on it)`;
